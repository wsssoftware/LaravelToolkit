...
export {default as InputDocument} from './Components/Form/InputDocument.vue'
export {default as InputGroup} from './Components/Form/InputGroup.vue'
export {default as InputPhone} from './Components/Form/InputPhone.vue'
...
export {default as Document} from './Components/Formatters/Document.vue'
export {default as Hour} from './Components/Formatters/Hour.vue'
export {default as Number} from './Components/Formatters/Number.vue'
export {default as Phone} from './Components/Formatters/Phone.vue'
export {default as Zip} from './Components/Formatters/Zip.vue'
