 ...
 * @method static array palete(null|string $hex = null, null|array $rbg = null, null|array $hsl = null, ColorStep $baseStep = ColorStep::STEP_500, ColorFormat $outputFormat = ColorFormat::HEX)
