...
it('can validate', function () {
    expect(Document::CPF->isValid('050.504.760-89'))
        ->toBeTrue()
        ->and(Document::CPF->isValid('050.504.760-29'))
        ->toBeFalse()
        ->and(Document::CPF->isValid('444.760.640-27'))
        ->toBeTrue()
        ->and(Document::CPF->isValid('444.760.640-21'))
        ->toBeFalse()
        ->and(Document::CNPJ->isValid('58.110.408/0001-04'))
        ->toBeTrue()
        ->and(Document::CNPJ->isValid('58.110.408/0001-12'))
        ->toBeFalse()
        ->and(Document::CNPJ->isValid('80.096.933/0001-63'))
        ->toBeTrue()
        ->and(Document::CNPJ->isValid('80.096.933/0001-43'))
        ->toBeFalse()
        ->and(Document::GENERIC->isValid('510.403.630-83'))
        ->toBeTrue()
        ->and(Document::GENERIC->isValid('510.403.630-81'))
        ->toBeFalse()
        ->and(Document::GENERIC->isValid('44.600.135/0001-63'))
        ->toBeTrue()
        ->and(Document::GENERIC->isValid('44.600.135/0001-62'))
        ->toBeFalse();
});
